...
export default function CreateWorkProfile() {
  return (
    <div className="lex flex-col w-full gap-[24px] text-primary-text-color-white items-center bg-primary-bg-color-blue py-[80px] md:px-0 px-[20px] justify-center ">
