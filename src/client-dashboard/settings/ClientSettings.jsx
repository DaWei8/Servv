...
import { clientProfileInfo, transactionData2 } from "../../data/Datasets";
...
const SettingsHomes = () => (
  <div className="settings-home Client-settings-container">
      ...
      <div className=" flex flex-wrap flex-auto gap-[20px] ">
        ...
        <div className="flex flex-col gap-[20px] w-full md:w-[350px] ">
          ...
          <div className=" flex flex-col gap-[10px]  ">
            <TextBoxCard
              title="First name"
              content={clientProfileInfo[0].firstName}
            />
            <TextBoxCard
              title="Last name"
              content={clientProfileInfo[0].lastName}
            />

            <TextBoxCard
              title="Other name"
              content={clientProfileInfo[0].otherName}
            />
            <TextBoxCard
              title="Country"
              content={clientProfileInfo[0].country}
            />
          </div>
        </div>
      </div>
