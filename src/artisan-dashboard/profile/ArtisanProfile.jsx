...
const ArtisanProfile = () => {
  return (
    <div className="artisan-profile w-full ">
...
const ArtisanProfileContent = () => {
  return (
    <div className="artisan-profile-content flex flex-col gap-[20px] ">
...
const ArtisanProfileInformation = () => {
  return (
    <div className="artisan-profile-information flex-3 ">
      <div className="artisan-profile-information-container flex gap-[10px] flex-col ">
