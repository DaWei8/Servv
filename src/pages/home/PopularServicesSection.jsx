...
const PopularServiceCard = (props) => {
  return (
    <div className=" md:h-[250px] flex-auto w-[130px] min-w-[130px] h-[160px] md:max-w-[330px] md:w-[300px] rounded-[10px] md:p-[20px] px-[10px] py-[20px]  gap-[10px] flex flex-col " style={{ background: props.color }}>
